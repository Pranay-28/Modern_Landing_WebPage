        ...
        <section className="py-24 overflow-hidden">
            <div className="container">
                ...
                <p className="text-white/50 mt-4 text-lg">
                    Layers seamlessy connnects with your favorite tools, making
                    it easy to plug into any workflow and collaborate across platforms.
                </p>
                </div>
                <div>
                <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 grid md:grid-cols-2 gap-4 overfow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
                <IntegrationCols integrations={integrations}/>
                <IntegrationCols integrations={integrations.slice().reverse()}
                 reverse
